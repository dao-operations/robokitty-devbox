...
GitHub Environment reviewer for deploy. Make the repo private before enabling
the persistent runner; if the repo intentionally remains public for a pilot,
set `vault_robokitty_deploy_runner_repo_visibility_ack:
public-repo-risk-accepted` and treat the pilot as time-boxed.
