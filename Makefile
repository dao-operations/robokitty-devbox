...
.PHONY: help prepare-ansible install-dev install-collections lint-yaml lint-ansible syntax codex-requirements-check sudoers-check github-broker-check deploy-runner-check worktree-helpers-check devbox-run-check live-config-helpers-check bootstrap-task-check cloud-init-check ci

help:
	@echo "Targets: install-dev lint-yaml lint-ansible syntax worktree-helpers-check devbox-run-check live-config-helpers-check bootstrap-task-check deploy-runner-check cloud-init-check ci"
...
ci: lint-yaml lint-ansible syntax codex-requirements-check sudoers-check github-broker-check deploy-runner-check worktree-helpers-check devbox-run-check live-config-helpers-check bootstrap-task-check cloud-init-check
