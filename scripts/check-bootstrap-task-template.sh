...
assert_contains "$default_output" "Before submitting, run this pre-submit checklist:" "pre-submit checklist"
assert_contains "$default_output" "git status --short" "pre-submit status"
assert_contains "$default_output" "git diff --stat" "pre-submit diff stat"
assert_contains "$default_output" "## Summary" "PR body summary section"
assert_contains "$default_output" "## Testing" "PR body testing section"
assert_contains "$default_output" "## Risks" "PR body risks section"
...
assert_contains "$default_output" "Do not bundle durable workflow or guidance changes" "workflow follow-up guidance"
